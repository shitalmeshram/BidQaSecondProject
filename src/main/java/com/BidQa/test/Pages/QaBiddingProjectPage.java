...
/**
 * Created by hishailesh77 on 5/19/2017.
 */
public class QaBiddingProjectPage {
    ...
    //verifying bid has been posted
    @FindBy(how= How.XPATH, using="//div[@class='bid_panel_ok']//div[@class='padd10']")
    private WebElement bidStatus;

    public String GetBidStatus(){
        return bidStatus.getText();
    }
